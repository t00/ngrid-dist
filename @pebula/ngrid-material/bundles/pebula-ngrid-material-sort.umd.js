(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var MatSortExtension = /** @class */ (function (_super) {
         ...
         */
        function (context) {
            return !!context.col.sort && !!context.injector.get(sort.MatSort, false);
        };
        /**
         * @param {?} context
         * @return {?}
         ...
         */
        function (context) {
            return this.cfr.resolveComponentFactory(sort.MatSortHeader);
        };
        /**
         * @param {?} context
         * @param {?} cmpRef
        ...
        function (context, id) {
            /** @type {?} */
            var matSort = context.injector.get(sort.MatSort);
            /** @type {?} */
