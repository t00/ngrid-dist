(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/cdk/overlay'), require('@angular/material/tooltip'), require('@pebula/ngrid'), require('@pebula/ngrid/target-events'), require('@angular/cdk/coercion'), require('@angular/cdk/a11y'), require('@angular/cdk/bidi'), require('@angular/cdk/scrolling'), require('@angular/cdk/platform'), require('@pebula/ngrid/core')) :
    typeof define === 'function' && define.amd ? define('@pebula/ngrid-material/cell-tooltip', ['exports', '@angular/core', '@angular/common', '@angular/cdk/overlay', '@angular/material/tooltip', '@pebula/ngrid', '@pebula/ngrid/target-events', '@angular/cdk/coercion', '@angular/cdk/a11y', '@angular/cdk/bidi', '@angular/cdk/scrolling', '@angular/cdk/platform', '@pebula/ngrid/core'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global.pebula = global.pebula || {}, global.pebula['ngrid-material'] = global.pebula['ngrid-material'] || {}, global.pebula['ngrid-material']['cell-tooltip'] = {}), global.ng.core, global.ng.common, global.ng.cdk.overlay, global.ng.material.tooltip, global.pebula.ngrid, global.pebula.ngrid['target-events'], global.ng.cdk.coercion, global.ng.cdk.a11y, global.ng.cdk.bidi, global.ng.cdk.scrolling, global.ng.cdk.platform, global.pebula.ngrid.core));
}(this, (function (exports, i0, common, overlay, tooltip, i1$1, targetEvents, coercion, a11y, bidi, scrolling, platform, i1) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var PblNgridCellTooltipDirective = /** @class */ (function () {
        ...
        PblNgridCellTooltipDirective.prototype.cellEnter = function (event) {
            ...
            if (this._canShow(event)) {
                ...
                params[1] = new i0.ElementRef(event.cellTarget);
                this.toolTip = new (tooltip.MatTooltip.bind.apply(tooltip.MatTooltip, __spreadArray([void 0], __read(params))))();
    ...
    /** @nocollapse */ PblNgridCellTooltipDirective.ɵdir = i0__namespace.ɵɵngDeclareDirective({ minVersion: "12.0.0", version: "12.0.0", type: PblNgridCellTooltipDirective, selector: "[cellTooltip]", inputs: { canShow: ["cellTooltip", "canShow"], message: "message", position: "position", tooltipClass: "tooltipClass", showDelay: "showDelay", hideDelay: "hideDelay" }, exportAs: ["pblOverflowTooltip"], ngImport: i0__namespace });
    ...
    PblNgridCellTooltipModule.NGRID_PLUGIN = i1$1.ngridPlugin({ id: PLUGIN_KEY, factory: 'create' }, PblNgridCellTooltipDirective);
    /** @nocollapse */ PblNgridCellTooltipModule.ɵfac = i0__namespace.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "12.0.0", ngImport: i0__namespace, type: PblNgridCellTooltipModule, deps: [{ token: PblNgridCellTooltipModule, optional: true, skipSelf: true }, { token: i1__namespace$1.PblNgridConfigService }], target: i0__namespace.ɵɵFactoryTarget.NgModule });
    /** @nocollapse */ PblNgridCellTooltipModule.ɵmod = i0__namespace.ɵɵngDeclareNgModule({ minVersion: "12.0.0", version: "12.0.0", ngImport: i0__namespace, type: PblNgridCellTooltipModule, declarations: [PblNgridCellTooltipDirective], imports: [common.CommonModule, tooltip.MatTooltipModule, overlay.OverlayModule, i1$1.PblNgridModule, targetEvents.PblNgridTargetEventsModule], exports: [PblNgridCellTooltipDirective, tooltip.MatTooltipModule] });
    /** @nocollapse */ PblNgridCellTooltipModule.ɵinj = i0__namespace.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "12.0.0", ngImport: i0__namespace, type: PblNgridCellTooltipModule, imports: [[common.CommonModule, tooltip.MatTooltipModule, overlay.OverlayModule, i1$1.PblNgridModule, targetEvents.PblNgridTargetEventsModule], tooltip.MatTooltipModule] });
    i0__namespace.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "12.0.0", ngImport: i0__namespace, type: PblNgridCellTooltipModule, decorators: [{
                type: i0.NgModule,
                args: [{
                        imports: [common.CommonModule, tooltip.MatTooltipModule, overlay.OverlayModule, i1$1.PblNgridModule, targetEvents.PblNgridTargetEventsModule],
                        declarations: [PblNgridCellTooltipDirective],
                        exports: [PblNgridCellTooltipDirective, tooltip.MatTooltipModule],
                    }]
            }], ctorParameters: function () {
            return [{ type: PblNgridCellTooltipModule, decorators: [{
                            type: i0.Optional
                        }, {
                            type: i0.SkipSelf
