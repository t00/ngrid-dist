...
import { FixedSizeVirtualScrollStrategy, VIRTUAL_SCROLL_STRATEGY, CdkScrollable, ScrollDispatcher, CdkVirtualScrollViewport, ScrollingModule } from '@angular/cdk/scrolling';
...
/** @type {?} */
var PEB_NGRID_CONFIG = new InjectionToken('PEB_NGRID_CONFIG');
...
PblDataSourceAdapter = /** @class */ (function () {
    ...
    function (filter$, sort$, pagination$, initialState) {
        ...
        var combine = [
             ...
             * @return {?}
             */
            function (value) { return createChangeContainer('filter', value, _this.cache); })), filter$1(changedFilter)),
            sort$.pipe(filter$1(skipUpdate), map((/**
             * @param {?} value
             * @return {?}
             */
            function (value) { return createChangeContainer('sort', value, _this.cache); })), filter$1(changedFilter)),
            pagination$.pipe(map((/**
             * @param {?} value
             * @return {?}
             */
            function (value) { return createChangeContainer('pagination', value, _this.cache); })), filter$1(changedFilter)),
            this._refresh$.pipe(map((/**
             * @param {?} value
             * @return {?}
             */
            function (value) { return fromRefreshDataWrapper(createChangeContainer('data', value, _this.cache)); })), filter$1(changedFilter)),
        ];
        /** @type {?} */
...
PblVirtualScrollForOf = /** @class */ (function () {
                ...
                if (event.deltaY) {
                    ...
                    if (newOffset !== offset_1) {
                        ...
                        if (metaRowStickyScroll_1.canMove() && metaRowStickyScroll_1.move(event.deltaY, viewPort_1.getBoundingClientRect())) {
                            /** @type {?} */
                            var scrollEnd$ = _this.viewport.scrolling.pipe(filter$1((/**
                             * @param {?} s
                             * @return {?}
                             */
                            function (s) { return !s; })));
                            ...
                            if (_this.viewport.wheelMode !== 'blocking') {
                                ...
                                if (wheelMode_1 === 'passive') {
                                    wheelUnListen_1();
                                    _this.viewport.scrolling.pipe(debounceTime(150), filter$1((/**
                                     * @param {?} s
                                     * @return {?}
                                     */
    ...
    function (ds) {
        ...
        if (ds) {
             ...
             * @return {?}
             */
            function () { return ds.length; })), startWith(0), pairwise(), filter$1((/**
             * @param {?} __0
             * @return {?}
             */
            function (_a) {
