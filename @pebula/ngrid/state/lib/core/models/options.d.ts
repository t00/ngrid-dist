...
export declare type StateChunkKeyFilter = {
    [P in keyof StateChunks]?: P extends keyof RootStateChunks ? RootStateChunks[P]['keyless'] extends never ? (Array<keyof RootStateChunks[P]['state']> | boolean) : boolean : Array<keyof StateChunks[P]['state']> | boolean;
};
...
export declare type PblNgridStateOptions = PblNgridStateLoadOptions | PblNgridStateSaveOptions;
