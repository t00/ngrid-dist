...
export declare type META_COLUMN_TYPES = 'header' | 'headerGroup' | 'footer';
export declare type COLUMN_TYPES = META_COLUMN_TYPES | 'table';
export interface PblColumnTypeDefinitionDataMap {
    [typeName: string]: any;
}
export declare type PblColumnTypeDefinition<P extends keyof PblColumnTypeDefinitionDataMap = any> = {
    name: P;
    data?: PblColumnTypeDefinitionDataMap[P];
};
/**
...
export interface PblColumnGroupDefinition extends PblBaseColumnDefinition {
    ...
    */
     ...
     * @deprecated Will be removed in v5, use columnIds instead
     */
    prop?: string;
    /**
