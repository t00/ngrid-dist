...
/** @internal */
export declare type RefreshDataWrapper<T> = {
    data: T;
};
/**
...
export declare type TriggerChangedEventResponse<T = any, TDate = any> = {
    event: PblDataSourceTriggerChangedEvent<TDate>;
    data: T[];
};
export declare type TriggerChangedEventFor<P extends keyof PblDataSourceTriggerCache> = P extends keyof PblDataSourceTriggerChangedEvent ? PblDataSourceTriggerChangedEvent[P] : PblDataSourceTriggerChange<PblDataSourceTriggerCache[P]>;
...
export declare type PblDataSourceTriggerChangeHandler<T, TEvent extends PblDataSourceTriggerChangedEvent<any>> = (event: TEvent) => (false | DataSourceOf<T>);
