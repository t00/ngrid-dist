...
export declare class PblNgridCellDefDirective<T, P extends keyof PblColumnTypeDefinitionDataMap = any> extends PblNgridBaseCellDef<PblNgridCellContext<T, P>> {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<PblNgridCellDefDirective<any, any>, "[pblNgridCellDef], [pblNgridCellTypeDef]", never, { "name": "pblNgridCellDef"; "type": "pblNgridCellTypeDef"; }, {}, never>;
}
