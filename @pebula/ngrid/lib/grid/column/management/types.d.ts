...
export declare type PblRowTypeToColumnTypeMap<T extends GridRowType> = T extends 'header' ? PblColumn : T extends 'data' ? PblColumn : T extends 'footer' ? PblColumn : T extends 'meta-header' ? PblMetaColumn | PblColumnGroup : T extends 'meta-footer' ? PblMetaColumn | PblColumnGroup : COLUMN;
