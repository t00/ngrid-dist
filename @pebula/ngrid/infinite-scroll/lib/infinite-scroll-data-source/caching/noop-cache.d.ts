 ...
 */
export declare class NoOpBlockCache implements PblNgridCacheAdapter<CacheAdapterOptions> {
    private readonly context;
    private readonly virtualRow;
    get maxSize(): number;
    get size(): number;
    get empty(): boolean;
    readonly options: CacheAdapterOptions;
    private readonly ds;
    constructor(context: PblInfiniteScrollDSContext<any>, virtualRow: any);
